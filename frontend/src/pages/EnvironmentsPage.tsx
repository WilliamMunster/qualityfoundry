...
import { Table, Button, Space, Tag, message, Modal, Form, Input, Switch } from 'antd';
import { PlusOutlined, CheckCircleOutlined, CloseCircleOutlined } from '@ant-design/icons';
import type { ColumnsType } from 'antd/es/table';
import { getEnvironments, createEnvironment, deleteEnvironment, healthCheck, type Environment } from '../api/environments';
...
const EnvironmentsPage: React.FC = () => {
    ...
    return (
        <div>
            ...
            <Table columns={columns} dataSource={environments} rowKey="id" loading={loading} />
